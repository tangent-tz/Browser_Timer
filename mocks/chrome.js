...
function createI18nMock() {
    ...
    const messages = {
        ...
        promoExt1Title: "SortIt - Automatic Downloads Organizer",
        promoExt1Description: "Automatically sorts downloaded files into folders so your Downloads stay clean.",
